...
import { Eye, EyeClosed, EyeOff, Ghost } from "lucide-react";
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res?.error) {
        ...
        // Jika login berhasil, ambil data session TERBARU
        ...
        <form onSubmit={handleLogin}>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Button type="button" variant="ghost" size="icon" className="absolute right-1 top-1/2 -translate-y-1/2 h-7 w-7 text-gray-500 hover:text-gray-900 dark:hover:text-gray-100" onClick={() => setShowPassword((prev) => !prev)}>
