      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid gap-10 lg:grid-cols-2 items-center">
          <div className="space-y-6">
            ...
            <h3 className="text-3xl font-bold leading-tight text-gray-900 dark:text-gray-100 sm:text-4xl">Mewujudkan nilai-nilai dimensi pada profil lulusan pada melalui pendidikan bermutu dan sekolah ramah anak.</h3>
