...
export default function LandingHero() {
  ...
  return (
    <section className="py-20 text-center sm:py-32 relative bg-cover bg-center" style={heroStyle}>
      ...
      <div className="container mx-auto max-w-3xl px-4 relative z-10">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Button asChild size="lg" variant="outline" className=" border-white hover:bg-amber-50 dark:hover:bg-white/10">
